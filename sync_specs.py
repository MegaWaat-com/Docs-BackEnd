...
TITLES_MAP = {
    ...
    "agency-branches": "نمایندگی‌ها و شعب",
    "02-product-catalog": "کاتالوگ کالا و قطعات",
    "specifications": "مشخصات فنی",
    "official-documents": "اسناد رسمی و کاتالوگ",
    "units-of-measure": "واحدهای سنجش",
    "part-numbers": "پارت نامبر و کدینگ",
    "creation-lifecycle": "چرخه حیات ایجاد",
    "external-integration": "اتصال به خارج و وب‌سرویس",
    "media-assets": "تصاویر و رسانه",
    "03-project-catalog": "کاتالوگ پروژه‌ها",
    "template-fields": "فیلدهای الگو",
    "04-ads": "سیستم آگهی‌ها",
    ...
    "partnership": "آگهی مشارکت صنعتی",
    "05-negotiation-room": "اتاق مذاکره و پیش‌نویس",
    ...
    "10-project-contract": "قرارداد پروژه و پیمانکاری",
    ...
    "field-experiences": "مستندسازی تجارب میدانی",
    "qna-discussions": "تالار پرسش و پاسخ",
    "certifications": "آزمون و گواهینامه‌ها",
    "instructor-payouts": "تسویه حساب مدرسین",
    "12-experts-and-services": "سامانه متخصصین و استادکاران",
    ...
    "task-dispatch": "ارجاع و هوشمندی تخصیص کار",
    "compensation-fee": "تعرفه‌ها و دستمزد",
    "service-calendar": "تقویم کاری و رزرو زمان",
    "13-finance-and-wallet": "سیستم مالی و کیف پول",
    "double-entry-accounting": "دفترکل دوبل و اسناد مالیاتی",
    "deposit-withdrawal": "واریز بانکی و پایا/ساتنا",
    "payment-gateways": "درگاه‌های شاپرکی",
    "wallet-freeze-escrow": "فریز وجوه و مسدودی بیعانه",
    "platform-fees": "تسهیم کارمزد پلتفرم",
    "14-platform-commons": "زیرساخت و سرویس‌های عمومی",
    "file-city-storage": "شهر فایل و S3 Storage",
    "notifications-engine": "موتور اعلان (SMS/Push)",
    ...
    "print-document-generator": "موتور تولید PDF و چاپ",
